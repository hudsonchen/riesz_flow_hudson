#!/bin/bash -l
#SBATCH --job-name=sliced_riesz_frozen_velocity_unit_rms_lr6e4_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_sliced_riesz_rms_lr6e4.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_sliced_riesz_frozen_velocity_unit_rms_lr6e4_ps_1"}
