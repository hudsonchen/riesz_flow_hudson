#!/bin/bash -l
#SBATCH --job-name=imagenet64_sliced_riesz
...
CONFIG=${CONFIG:-configs/gen/imagenet64_sliced_riesz.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_sliced_riesz_patch1"}
