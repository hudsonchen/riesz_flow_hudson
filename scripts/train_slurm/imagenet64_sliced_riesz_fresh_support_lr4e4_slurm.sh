#!/bin/bash -l
#SBATCH --job-name=sliced_fresh_lr4e4_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_sliced_riesz_fresh_support_lr4e4.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_sliced_riesz_fresh_support_lr4e4_mingyuan_const_ps_1"}
