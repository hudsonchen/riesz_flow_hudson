#!/bin/bash -l
#SBATCH --job-name=sliced_riesz_rms_ablation_imagenet256
...
export CONFIG=${CONFIG:-configs/gen/imagenet256_ablation_sliced_riesz_rms.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_ablation_sliced_riesz_frozen_velocity_rms_2nodes}
