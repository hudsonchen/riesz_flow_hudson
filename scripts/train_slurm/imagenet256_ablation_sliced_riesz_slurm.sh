#!/bin/bash -l
#SBATCH --job-name=sliced_riesz_ablation_imagenet256
...
export CONFIG=${CONFIG:-configs/gen/imagenet256_ablation_sliced_riesz.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_ablation_sliced_riesz_2nodes}
