#!/bin/bash -l
#SBATCH --job-name=mingyuan_riesz150k_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_150k_mingyuan.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_riesz_150k_mingyuan_ps_1"}
