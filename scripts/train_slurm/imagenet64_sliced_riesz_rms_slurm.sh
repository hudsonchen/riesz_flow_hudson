#!/bin/bash -l
#SBATCH --job-name=sliced_riesz_frozen_velocity_rms_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_sliced_riesz_rms.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_sliced_riesz_frozen_velocity_rms_ps_1"}
