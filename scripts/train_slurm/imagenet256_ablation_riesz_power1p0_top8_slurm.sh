#!/bin/bash -l
#SBATCH --job-name=riesz_top8_p1p0_imagenet256
...
export CONFIG=${CONFIG:-configs/gen/imagenet256_ablation_riesz_power1p0_top8.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_ablation_riesz_power1p0_top8_2nodes}
