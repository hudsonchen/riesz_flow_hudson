#!/bin/bash -l
#SBATCH --job-name=sliced_saved_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_sliced_riesz_saved_support.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_sliced_riesz_saved_support_mingyuan_const_ps_1"}
