#!/bin/bash -l
#SBATCH --job-name=sinkhorn_const_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_sinkhorn_150k_mingyuan_const.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_sinkhorn_150k_mingyuan_const_ps_1"}
