#!/bin/bash -l
#SBATCH --job-name=riesz_p1_top8_frozen_rms_imagenet256
...
export CONFIG=${CONFIG:-configs/gen/imagenet256_ablation_riesz_p1p0_top8_rms.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_ablation_riesz_p1p0_top8_frozen_velocity_rms_2nodes}
