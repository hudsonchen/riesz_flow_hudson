#!/bin/bash -l
#SBATCH --job-name=riesz_power0p5_top20_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_power0p5_top20.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_riesz_power0p5_top20_no_rms_lr4e4_warmup2k_ps_1"}
