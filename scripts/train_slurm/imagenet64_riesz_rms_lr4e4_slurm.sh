#!/bin/bash -l
#SBATCH --job-name=riesz_frozen_velocity_rms_lr4e4_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_rms_lr4e4.yaml}
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_riesz_frozen_velocity_rms_lr4e4_ps_1"}
