#!/bin/bash -l
#SBATCH --job-name=riesz_top8_frozen_rms_imagenet64
...
CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_top8_rms_lr4e4.yaml}
# Hudson-specific path: intentionally distinct from all Sophia workdirs.
WORKDIR=${WORKDIR:-"${RDS_ROOT}/runs/imagenet64_riesz_top8_frozen_velocity_rms_lr4e4_hudson_ps_1"}
