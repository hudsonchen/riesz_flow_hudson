#!/bin/bash -l
#SBATCH --job-name=sinkhorn_ablation_imagenet256
...
export CONFIG=${CONFIG:-configs/gen/imagenet256_ablation_sinkhorn.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_ablation_sinkhorn_2nodes}
